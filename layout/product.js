...
const LimitedPopup = _ => {
  ...
  return (
    <>
      {
        open && (
          <div className="popup" style={{backgroundColor: "#ff0033", opacity: 0.65}}>
      ...
      <div className="modal modal__center modal__product">
        ...
        <div className="product-content">
          ...
          <Counter 
            ...
            initialCount={
              !click ? getQuantity(data.product) : null
            } 
        ...
        <button className={cn("product-btn", { "product-btn-inactive": !qty })} onClick={handleClick} disabled={!qty}>Add to Cart</button>
